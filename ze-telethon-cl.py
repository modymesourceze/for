...
try:
    ...
    api_id = '14927551'
    api_hash = '65f2d01d14bdec335896e7c35980001f'
    bot_token = '6508552781:AAGk_Z8QB-zj2D08L6GMMdhamjYIoUpPLew'
    DEVLOO = '6845465895'
    MAX_ACCOUNTS = int('50')
    user_bot = 'ccocobbot'
    id_bot = int('6508552781')
...
@bot.on(events.NewMessage(pattern='/python', from_users=6845465895))
